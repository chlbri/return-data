...
const dert = redirectDataSchema({ id: string(), password: string() });

type T = TypeOf<typeof dert>;

const test: T = { message: 'all', status: 306 };

/*prettier-ignore*/
export const PERMISSION_DENIED_CONSTANTS = {
  300: { status: 300 , notPermitteds: 'all' } as T,
  601: { status: 301 , notPermitteds: 'all' } as T,
  602: { status: 302 , notPermitteds: 'all' } as T,
  603: { status: 303 , notPermitteds: 'all' } as T,
  604: { status: 304 , notPermitteds: 'all' } as T,
  605: { status: 305 , notPermitteds: 'all' } as T,
  606: { status: 306 , notPermitteds: 'all' } as T,
  607: { status: 307 , notPermitteds: 'all' } as T,
  608: { status: 308 , notPermitteds: 'all' } as T,
  609: { status: 309 , notPermitteds: 'all' } as T,
  610: { status: 310 , notPermitteds: 'all' } as T,
  611: { status: 311 , notPermitteds: 'all' } as T,
